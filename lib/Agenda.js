...
var Agenda = function (_React$Component) {
  ...
  Agenda.prototype.render = function render() {
    ...
    var _props = this.props,
        ...
        length = _props$length === undefined ? 7 : _props$length,
        date = _props.date,
    ...
    var WrapperComponent = components.wrapper;

    var range = _dates2.default.range(date, end, 'day');

    if (WrapperComponent) {
      return _react2.default.createElement(WrapperComponent, { date: date, events: events });
    }
...
Agenda.range = function (date, _ref2) {
