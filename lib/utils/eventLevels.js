...
function sortEvents(evtA, evtB, _ref3) {
  var startAccessor = _ref3.startAccessor,
      ...
      sortBy = _ref3$sortBy === undefined ? _noop2.default : _ref3$sortBy,
      _ref3$isSpecialEvent = _ref3.isSpecialEvent,
      isSpecialEvent = _ref3$isSpecialEvent === undefined ? function () {} : _ref3$isSpecialEvent;
  ...
  return isSpecialEvent(evtA) === isSpecialEvent(evtB) ? 0 : isSpecialEvent(evtA) ? -1 : 1 || startSort // sort by start Day first
  ...
  || sortBy(evtA, evtB); // then pass in sort function
}