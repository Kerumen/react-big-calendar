...
function sortEvents(evtA, evtB, _ref) {
  var start = _ref.start,
    end = _ref.end,
    sortBy = _ref.sortBy,
    allDay = _ref.allDay,
    _ref$isSpecialEvent = _ref.isSpecialEvent,
    isSpecialEvent =
      _ref$isSpecialEvent === void 0
        ? function() {
            return true
          }
        : _ref$isSpecialEvent
  var startSort =
    +_dates.default.startOf(start(evtA), 'day') -
    +_dates.default.startOf(start(evtB), 'day')

  var durA = _dates.default.diff(
    start(evtA),
    _dates.default.ceil(end(evtA), 'day'),
    'day'
  )

  var durB = _dates.default.diff(
    start(evtB),
    _dates.default.ceil(end(evtB), 'day'),
    'day'
  )
